...
# %%
MANIFOLD_USERNAME = os.environ.get("MANIFOLD_USERNAME") or keyring.get_password(
    "manifold.markets", "MANIFOLD_USERNAME"
)
MANIFOLD_APIKEY = os.environ.get("MANIFOLD_APIKEY") or keyring.get_password(
    "manifold.markets", "MANIFOLD_APIKEY"
)
...
def get_credentials():
    username = os.environ.get("MANIFOLD_USERNAME") or keyring.get_password(
        "manifold.markets", "MANIFOLD_USERNAME"
    )
    api_key = os.environ.get("MANIFOLD_APIKEY") or keyring.get_password(
        "manifold.markets", "MANIFOLD_APIKEY"
    )
    try:
